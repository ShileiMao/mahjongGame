...
export class History extends Component {
    ...
    private _viewitemTemp = 'null';
    private _historyData = 'null';
    private _curRoomInfo = 'null';
    private _emptyTip = 'null';
    ...
    initGameHistoryList (roomInfo: any, data: any) {
        //data.sort(function(a,b){
