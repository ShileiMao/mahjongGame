...
export class Settings extends Component {
  ...
  onLoad() {
    ...
    AppGlobal.vv().utils.addSlideEvent(
      slider,
      this.node,
      "Settings",
      "onSlided"
  ...
  refreshVolume() {
    ...
    AppGlobal.vv().utils.setSize(progress.getChildByName("progress"), {
      width: width,
    });
