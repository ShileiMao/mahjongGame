...
@ccclass('VoiceMgr')
export class VoiceMgr extends Component {
    @property
    public onPlayCallback = 'null';
    private _voiceMediaPath = 'null';

    init () {
        // var url = url.raw("resources/test.amr");
    ...
    writeVoice (filename: any, voiceData: any) {
        //if(!cc.sys.isNative){
        //    return;
        //}
