...
export class AudioMgr extends Component {
  ...
  playBGM(url: any) {
    ...
    this.play(audioUrl, this.bgmVolume);
  }
  ...
  play(sound: AudioClip | string, volume: number = 1.0) {
    console.log("Play sound called !!!!, audio source: " + this._audioSource);
    if (!this._audioSource || volume <= 0) {
        return
    }
